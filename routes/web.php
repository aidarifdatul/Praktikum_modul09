...
use Illuminate\Http\Request; //digunakan untuk proses pengambilan file upload-an
...
//Rote untuk meletakkan file pada Local Disk
...
//Route untuk menyimpan file via form
...
//Route download file pada form employee
